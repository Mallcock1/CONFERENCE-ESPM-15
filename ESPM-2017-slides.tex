...
\begin{itemize}
\item Add \textbf{magnetic field} outside the slab - coronal structures. See \textbf{Mihai Barbulescu}'s poster.
\item Add \textbf{steady flow} - dynamic structures e.g. solar wind.
\end{itemize}
