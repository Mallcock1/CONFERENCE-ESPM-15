...
\begin{itemize}
\item Add \textcolor{red}{\textbf{magnetic field}} outside the slab - coronal structures. See \textbf{Zs\'{a}mberger and Erd\'{e}lyi}, published soon.
\item Add \textcolor{cyan}{\textbf{steady flow}} - dynamic structures e.g. solar wind. See \textbf{Mihai Barbulescu}'s poster.
\end{itemize}
...
\draw [line width=\lw, cyan, path fading=north] (4.25,-0.3) -- (4.25, 1.7);
\draw [line width=\lw, cyan, path fading=south] (4.25,-0.6) -- (4.25,-0.3);
\draw [line width=\lw, cyan, path fading=south] (4.25,2.2) -- (4.25,4.4);
\draw [line width=\lw, cyan, -stealth] (4.25,4.4) -- (4.25,4.5);
\draw [line width=\lw, cyan, path fading=north] (4.75,-0.3) -- (4.75, 1.7);
\draw [line width=\lw, cyan, path fading=south] (4.75,-0.6) -- (4.75,-0.3);
\draw [line width=\lw, cyan, path fading=south] (4.75,2.2) -- (4.75,4.4);
\draw [line width=\lw, cyan, -stealth] (4.75,4.4) -- (4.75,4.5);
\draw [line width=\lw, cyan, path fading=north] (5.25,-0.3) -- (5.25, 1.7);
\draw [line width=\lw, cyan, path fading=south] (5.25,-0.6) -- (5.25,-0.3);
\draw [line width=\lw, cyan, path fading=south] (5.25,2.2) -- (5.25,4.4);
\draw [line width=\lw, cyan, -stealth] (5.25,4.4) -- (5.25,4.5);
\draw [line width=\lw, cyan, path fading=north] (5.75,-0.3) -- (5.75, 1.7);
\draw [line width=\lw, cyan, path fading=south] (5.75,-0.6) -- (5.75,-0.3);
\draw [line width=\lw, cyan, path fading=south] (5.75,2.2) -- (5.75,4.4);
\draw [line width=\lw, cyan, -stealth] (5.75,4.4) -- (5.75,4.5);
