...
\begin{tikzpicture}[node distance=1.8cm and 3.cm, auto, >=latex, align = flush center, ultra thick, on grid=true, font=\small]
    ...
    \path[onslide=<7>{alert}, onslide=<10>{green}]<7-> node[format, right= of sp] (ts) {
    					\tb{Temporal} \\
    					\tb{magneto-seismology}};
    \path[onslide=<7>{alert}]<7-> (ts) edge[<-] (tp);
    \node <7-> at (6,-2) (ghost2) {};
    \draw <7-> [->, onslide=<7>{alert}, onslide=<10>{green}] (ghost2.center) -- (ts);
    \draw <7-> [onslide=<7>{alert}, onslide=<10>{green}] (ghost2.center) -- (eig);
    \path[onslide=<7>{alert}]<7-> node[format, below right= of sp] (ss) {
    					\tb{Spatial} \\
    					\tb{magneto-seismology}}
                   edge[<-] (eig)
                   edge[<-] (sp);
    ...
    \path[onslide=<8>{alert}, onslide=<10>{green}]<8-> (ts) edge[->] (ep);
	\path[onslide=<8>{alert}]<8-> (ss) edge[->] (ep);    
...
\begin{itemize}
\item<2-> Add \textcolor{red}{\textbf{magnetic field}} outside the slab - coronal structures. See \textbf{Zs\'{a}mberger and Erd\'{e}lyi}, published soon.
\item<3-> Add \textcolor{cyan}{\textbf{steady flow}} - dynamic structures e.g. solar wind. See \textbf{Mihai Barbulescu}'s poster.
\end{itemize}
...
\draw<2-> [ultra thick, red, -stealth] (3,0) -- (3,4);
\draw<2-> [ultra thick, red, path fading=south] (3,-0.3) -- (3,0);
\draw<2-> [ultra thick, red, path fading=north] (2,0) -- (2, 2.2);
\draw<2-> [ultra thick, red, path fading=south] (2,-0.3) -- (2,0);
\draw<2-> [ultra thick, red, path fading=south] (2,2.7) -- (2,3.9);
\draw<2-> [ultra thick, red, -stealth] (2,3.9) -- (2,4);
\draw<2-> [ultra thick, red, path fading=south] (1,-0.3) -- (1, 0);
\draw<2-> [ultra thick, red, -stealth] (1,0) -- (1,4);
...
\draw<3-> [line width=\lw, cyan, path fading=north] (4.25,-0.3) -- (4.25, 1.7);
\draw<3-> [line width=\lw, cyan, path fading=south] (4.25,-0.6) -- (4.25,-0.3);
\draw<3-> [line width=\lw, cyan, path fading=south] (4.25,2.2) -- (4.25,4.4);
\draw<3-> [line width=\lw, cyan, -stealth] (4.25,4.4) -- (4.25,4.5);
\draw<3-> [line width=\lw, cyan, path fading=north] (4.75,-0.3) -- (4.75, 1.7);
\draw<3-> [line width=\lw, cyan, path fading=south] (4.75,-0.6) -- (4.75,-0.3);
\draw<3-> [line width=\lw, cyan, path fading=south] (4.75,2.2) -- (4.75,4.4);
\draw<3-> [line width=\lw, cyan, -stealth] (4.75,4.4) -- (4.75,4.5);
\draw<3-> [line width=\lw, cyan, path fading=north] (5.25,-0.3) -- (5.25, 1.7);
\draw<3-> [line width=\lw, cyan, path fading=south] (5.25,-0.6) -- (5.25,-0.3);
\draw<3-> [line width=\lw, cyan, path fading=south] (5.25,2.2) -- (5.25,4.4);
\draw<3-> [line width=\lw, cyan, -stealth] (5.25,4.4) -- (5.25,4.5);
\draw<3-> [line width=\lw, cyan, path fading=north] (5.75,-0.3) -- (5.75, 1.7);
\draw<3-> [line width=\lw, cyan, path fading=south] (5.75,-0.6) -- (5.75,-0.3);
\draw<3-> [line width=\lw, cyan, path fading=south] (5.75,2.2) -- (5.75,4.4);
\draw<3-> [line width=\lw, cyan, -stealth] (5.75,4.4) -- (5.75,4.5);

\draw<2-> [ultra thick, red, path fading=north] (8,0) -- (8, 2.2);
\draw<2-> [ultra thick, red, path fading=south] (8,-0.3) -- (8,0);
\draw<2-> [ultra thick, red, path fading=south] (8,2.7) -- (8,3.9);
\draw<2-> [ultra thick, red, -stealth] (8,3.9) -- (8,4);
\draw<2-> [ultra thick, red, -stealth] (9,3.9) -- (9,4);
\draw<2-> [ultra thick, red, path fading=south] (9,-0.3) -- (9,0);
\draw<2-> [ultra thick, red, path fading=south] (9,2.7) -- (9,3.9);
\draw<2-> [ultra thick, red, path fading=north] (9,0) -- (9,2.2);
...
\node [right] at (7.1,2.5) {$\rho_2$, $p_2$, $T_2$};
\Large
\node<3-> [cyan] at (5,4.7) {$\mathbf{U_0}$};
\end{tikzpicture}
}
\end{figure}
\end{frame}
...
\includegraphics<1>[height=3.5 cm]{media/mbptogether.png}
\\
\centering
\tiny
\only<2>{NASA}
